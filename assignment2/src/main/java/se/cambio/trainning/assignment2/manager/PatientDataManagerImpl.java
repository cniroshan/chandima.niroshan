...
public class PatientDataManagerImpl {
	...
	public List<PatientData> getFilteredPatientDataList(SearchCriteria criteria) {
		...
		if (!(criteria.getName().equals("")) && (criteria.getBirthYear() > 0) && !criteria.isIncludeMale() // name,bday
			...
			criteriaType = 1;
		} else if (!(criteria.getName().equals("")) && (criteria.getBirthYear() > 0) && criteria.isIncludeMale()) {// name,bday,male
			criteriaType = 2;
		} else if (!(criteria.getName().equals("")) && (criteria.getBirthYear() > 0) && criteria.isIncludeFemale()) {// name,bday,female
			criteriaType = 3;
		} else if (!(criteria.getName().equals("")) && (criteria.getBirthYear() == 0) && !criteria.isIncludeFemale()
				&& !criteria.isIncludeMale()) {// name
			criteriaType = 4;
		} else if ((criteria.getName().equals("")) && (criteria.getBirthYear() > 0) && !criteria.isIncludeFemale()
				&& !criteria.isIncludeMale()) {// bday
			criteriaType = 5;
		} else if ((criteria.getName().equals("")) && (criteria.getBirthYear() == 0) && criteria.isIncludeFemale()
				&& !criteria.isIncludeMale()) {// female
			criteriaType = 6;
		} else if ((criteria.getName().equals("")) && (criteria.getBirthYear() == 0) && criteria.isIncludeMale()
				&& !criteria.isIncludeFemale()) {// male
			criteriaType = 7;
		} else if ((criteria.getName().equals("")) && (criteria.getBirthYear() > 0) && criteria.isIncludeFemale()
				&& !criteria.isIncludeMale()) {// bday,female
			criteriaType = 8;
		} else if ((criteria.getName().equals("")) && (criteria.getBirthYear() > 0) && !criteria.isIncludeFemale()
				&& criteria.isIncludeMale()) {// bday,male
			criteriaType = 9;
		} else if (!(criteria.getName().equals("")) && (criteria.getBirthYear() == 0) && !criteria.isIncludeFemale()
				&& criteria.isIncludeMale()) {// name,male
			criteriaType = 10;
		} else if (!(criteria.getName().equals("")) && (criteria.getBirthYear() == 0) && criteria.isIncludeFemale()
				&& !criteria.isIncludeMale()) {// name,female
			criteriaType = 11;
		}
