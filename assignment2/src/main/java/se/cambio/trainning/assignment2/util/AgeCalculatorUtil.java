...
public class AgeCalculatorUtil {
	...
	private static String getAgeString(Date birthday, Calendar todayTime, Calendar bornTime,
			int yearsBetweenBdayAndToday, int age, int monthsBetweenBdayAndToday) {
		String ageString = "";
		if (birthday != null) {
