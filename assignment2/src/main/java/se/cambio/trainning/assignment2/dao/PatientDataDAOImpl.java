...
public class PatientDataDAOImpl {
	...
	PatientData patient2 = new PatientData(2, "Billy", new DateTime(new Date()).minusYears(25).toDate(),
			"No 17, Kottawa", Gender.Female, "0718745125", EmploymentStatus.PartTime);
